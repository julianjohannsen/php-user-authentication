...
var SekindoClientDetections_URL = function (config) {
	...
	this.setInfo();
				...
				var urlDetObj = new SekindoClientDetections_URL({
					url: 'https://live.sekindo.com/live/liveView.php?s=100431&cbuster=[CACHE_BUSTER]&pubUrl=[PAGE_URL_ENCODED]&x=[WIDTH]&y=[HEIGHT]&vp_content=plembed155blkzgtxiv&vp_template=6130&subId=[SUBID_ENCODED]&cbuster=1607775793',
					...
					floatConfig: {
						...
						direction: 'tr', verticalOffset: 60,
